...
const MyButton = class {
  ...
  render() {
    ...
    }[this.color] || 'bg-blue-600 text-white hover:bg-blue-700';
    const sizeClasses = {
      small: 'text-sm px-3 py-1',
      medium: 'text-base',
      large: 'text-lg px-6 py-3',
    }[this.size] || '';
    return (h("button", { class: `${baseClasses} ${colorClasses} ${sizeClasses}` }, this.icon && h("i", { class: `${this.icon} mr-2` }), this.label));
  }
};
